      ...
      <div class="manage_tip">
        ...
        >
          ...
          <el-form-item>
            ...
            <el-button type="success" class="submit_btn" style="width:45%;" @click="toLogin">返回登录</el-button>
            <el-button type="primary" class="submit_btn" style="width:50%;float:right;" @click="submitForm('registerForm')">立即注册</el-button>
          </el-form-item>
        </el-form>
      </div>
    </section>
...
export default {
  ...
  methods: {
    submitForm(formdata) {
      this.$message.warning("注册功能尚未启用,敬请期待!");
    },
    toLogin() {
